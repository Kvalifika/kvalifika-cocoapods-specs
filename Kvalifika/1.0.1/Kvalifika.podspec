Pod::Spec.new do |spec|
    ...
    spec.source         = { :git => 'https://kvalifika-ios.s3.eu-central-1.amazonaws.com/sdk/Kvalifika-1.0.1.xcframework.zip',:git => 'https://github.com/getsentry/sentry-cocoa.git', :tag => spec.version.to_s }
